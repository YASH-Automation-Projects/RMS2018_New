...
public class Report 
{
	...
	{
		Reporter.log("<table border=1px; style= width:100%;color=#808080>" + "<tr> <th width=20%>Browser Selected</th> <th width=20%> Environment Used</th></tr>");
		ReprotDetails = 1;
	}
	...
	@Test
	public
 static void ReporterOutputHeader() throws InterruptedException 
	{
		Thread.sleep(1000);
		stepnum=0;
	...
	public static void ReporterOutput(String ptestcaseID,String pStepDescription,
			String pInputValue, String pExpectedValue, String pActualValue,
			String pResult, String pId) throws Throwable {
		...
		Reporter.log(trstart + thstart + TestcaseID + thend + thstart + StepDescription + thend + thstart
				+ InputValue + thend + thstart + ExpectedValue + thend
				+ thstart + ActualValue + thend + Result + trend);
	}
