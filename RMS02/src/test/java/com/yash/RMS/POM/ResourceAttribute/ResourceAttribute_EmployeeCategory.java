...
public class ResourceAttribute_EmployeeCategory {
...
private static WebElement element = null;
	...
	public static WebElement EmployeeCategoryTableID(WebDriver driver) {
		element = driver.findElement(By.xpath(".//*[@id='example']"));
		return element;	
	}
	
	public static WebElement TextBox_AddEmployeeCategory(WebDriver driver) {
	...
	public static WebElement TextBox_EditEmployeeCategory(WebDriver driver) {
	...
	public static WebElement EmployeeCategoryName(WebDriver driver) {
